...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle2 = self.canvas_widget.create_image(
            0, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 3
        ...
        self.obstacle4 = self.canvas_widget.create_image(
            pixels * 3, pixels * 2, anchor='nw', image=self.obstacle5_object)
        # Obstacle 5
        self.obstacle5 = self.canvas_widget.create_image(
            pixels * 4, 0, anchor='nw', image=self.obstacle5_object)
        # Obstacle 6
        self.obstacle6 = self.canvas_widget.create_image(
            pixels * 5, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(
            pixels * 7, pixels * 3, anchor='nw', image=self.obstacle12_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(
            pixels * 6, pixels, anchor='nw', image=self.obstacle12_object)
        # Obstacle 9
        ...
        self.obstacle12 = self.canvas_widget.create_image(
            pixels * 4, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(
            0, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(
            pixels * 3, pixels * 6, anchor='nw', image=self.obstacle2_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(
            0, pixels * 4, anchor='nw', image=self.obstacle2_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(
            pixels * 8, 0, anchor='nw', image=self.obstacle12_object)
        # Obstacle 17
        ...
        self.obstacle18 = self.canvas_widget.create_image(
            0, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(
            pixels, pixels * 6, anchor='nw', image=self.obstacle2_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(
            pixels * 5, pixels * 2, anchor='nw', image=self.obstacle12_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(
            pixels * 5, pixels * 3, anchor='nw', image=self.obstacle12_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(
            pixels * 6, pixels * 3, anchor='nw', image=self.obstacle12_object)
        # Obstacle 23
        ...
        self.obstacle25 = self.canvas_widget.create_image(
            pixels * 6, pixels * 2, anchor='nw', image=self.obstacle12_object)
        # Obstacle 26
        self.obstacle26 = self.canvas_widget.create_image(
            pixels * 7, pixels * 2, anchor='nw', image=self.obstacle12_object)
        # Obstacle 27
        self.obstacle27 = self.canvas_widget.create_image(
            pixels * 2, pixels * 4, anchor='nw', image=self.obstacle2_object)
        # Obstacle 28
        self.obstacle28 = self.canvas_widget.create_image(
            pixels * 2, pixels * 6, anchor='nw', image=self.obstacle2_object)
        # Obstacle 29
        self.obstacle29 = self.canvas_widget.create_image(
            pixels * 2, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 30
        self.obstacle30 = self.canvas_widget.create_image(
            pixels * 1, pixels * 3, anchor='nw', image=self.obstacle2_object)
        # Obstacle 31
        self.obstacle31 = self.canvas_widget.create_image(
            pixels * 2, pixels * 8, anchor='nw', image=self.obstacle2_object)
        # Obstacle 32
        self.obstacle32 = self.canvas_widget.create_image(
            pixels * 2, pixels * 1, anchor='nw', image=self.obstacle5_object)

        # Final Point
        img_flag = Image.open("images/agent2.png")
        self.flag_object = ImageTk.PhotoImage(img_flag)
        self.flag = self.canvas_widget.create_image(
            pixels, pixels * 4, anchor='nw', image=self.flag_object)
